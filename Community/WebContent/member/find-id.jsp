...
<aside class="section-fl" style="margin-bottom: -9999px; padding-bottom: 9999px; width: 200px; display: inline-block; background-color:#ae875d;">
	...
	<ul style="list-style: none; margin: 0; padding: 0;">
		...
		<li style="height: 50px; border-bottom: 0.5px solid white; background-color: #CEA67A;"><a class="li-findId" href="<%=request.getContextPath()%>/member/find-id.jsp" style="margin-right: 10px; text-decoration: none; color: white; height: inherit; width: 190px; display: inline-block;"><span>아이디찾기</span></a></li>
